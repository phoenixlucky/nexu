  ...
  return (
    <section id="faq" className="px-6 py-24 mx-auto max-w-2xl">
      <div className="mb-14 text-center">
        <div className="text-[11px] font-semibold text-accent mb-3 tracking-widest uppercase">FAQ</div>
        <h2 className="text-2xl font-bold tracking-tight text-text-primary">You might be wondering</h2>
      </div>
      <div>
        {FAQ_ITEMS.map((item) => (
