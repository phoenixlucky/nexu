const zhCN = {
  ...
  "wecomSetup.desc":
    "填写企业微信机器人的 Bot ID 和 Secret。Nexu 会保存凭据，并把 wecom 渠道同步到 OpenClaw。",
  "wecomSetup.quickSetup": "快速配置",
  "wecomSetup.step1": "打开企业微信机器人管理页，创建或选择你的机器人。",
  "wecomSetup.step2": "从机器人设置页复制 Bot ID。",
  "wecomSetup.step3": "复制 Secret 并粘贴到下方。",
  "wecomSetup.step4": "确认当前 OpenClaw 运行环境里已经安装 wecom 插件。",
  "wecomSetup.botIdLabel": "Bot ID",
  "wecomSetup.botIdPlaceholder": "你的企业微信 Bot ID",
  "wecomSetup.secretLabel": "Secret",
  "wecomSetup.secretPlaceholder": "你的企业微信机器人 Secret",
  "wecomSetup.testConnectivity": "测试连通性",
  "wecomSetup.connect": "连接企业微信",
  "wecomSetup.credentialsRequired": "企业微信 Bot ID 和 Secret 不能为空",
  "wecomSetup.testFailed": "企业微信连通性测试失败",
  "wecomSetup.testSuccess": "企业微信连通性测试通过",
