const en = {
  ...
  "wecomSetup.desc":
    "Use your WeCom Bot ID and Secret. Nexu will store the credentials and sync the wecom channel into OpenClaw.",
  "wecomSetup.quickSetup": "Quick setup",
  "wecomSetup.step1":
    "Open the WeCom bot management page and create or select your bot.",
  "wecomSetup.step2": "Copy the Bot ID from the bot settings page.",
  "wecomSetup.step3": "Copy the bot Secret and paste it below.",
  "wecomSetup.step4":
    "Make sure the wecom plugin is installed in your OpenClaw runtime.",
  "wecomSetup.botIdLabel": "Bot ID",
  "wecomSetup.botIdPlaceholder": "Your WeCom Bot ID",
  "wecomSetup.secretLabel": "Secret",
  "wecomSetup.secretPlaceholder": "Your WeCom bot Secret",
  ...
  "wecomSetup.testFailed": "WeCom connectivity test failed",
  "wecomSetup.testSuccess": "WeCom connectivity test passed",
